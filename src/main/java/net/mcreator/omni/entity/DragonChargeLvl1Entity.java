...
import net.mcreator.omni.procedures.DragonChargeLvl1TargetProcedure;
import net.mcreator.omni.procedures.DragonChargeLvl1FollowTargetProcedure;
import net.mcreator.omni.init.OmniModEntities;

import javax.annotation.Nullable;

public class DragonChargeLvl1Entity extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public DragonChargeLvl1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(OmniModEntities.DRAGON_CHARGE_LVL_1.get(), world);
	}

	public DragonChargeLvl1Entity(EntityType<DragonChargeLvl1Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		DragonChargeLvl1TargetProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		DragonChargeLvl1FollowTargetProcedure.execute(this.getX(), this.getY(), this.getZ(), this);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DragonChargeLvl1Entity.RemovalReason.KILLED);
		}
	}
