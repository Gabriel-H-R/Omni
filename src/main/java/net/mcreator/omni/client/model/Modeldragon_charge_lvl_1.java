package net.mcreator.omni.client.model;
...
public class Modeldragon_charge_lvl_1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("omni", "modeldragon_charge_lvl_1"), "main");
	public final ModelPart Charge;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = Charge.addOrReplaceChild("Body", CubeListBuilder.create(), PartPose.offset(0.6F, 0.0F, 24.2667F));
		PartDefinition CentralBody = Body.addOrReplaceChild("CentralBody",
				CubeListBuilder.create().texOffs(100, 116).addBox(-10.6F, -6.0F, -22.2667F, 2.0F, 12.0F, 48.0F, new CubeDeformation(0.0F))
						.texOffs(72, 66).addBox(-6.6F, -10.0F, -22.2667F, 12.0F, 2.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition CentralBody2 = Body.addOrReplaceChild("CentralBody2",
				CubeListBuilder.create().texOffs(100, 116).addBox(-10.6F, -6.0F, -24.2667F, 2.0F, 12.0F, 48.0F, new CubeDeformation(0.0F))
						.texOffs(72, 66).addBox(-6.6F, -10.0F, -24.2667F, 12.0F, 2.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition CentralBody3 = Body.addOrReplaceChild("CentralBody3",
				CubeListBuilder.create().texOffs(100, 116).addBox(-10.6F, -6.0F, -34.2667F, 2.0F, 12.0F, 48.0F, new CubeDeformation(0.0F))
						.texOffs(72, 66).addBox(-6.6F, -10.0F, -34.2667F, 12.0F, 2.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition CentralBody4 = Body.addOrReplaceChild("CentralBody4",
				CubeListBuilder.create().texOffs(100, 116).addBox(-10.6F, -6.0F, -49.2667F, 2.0F, 12.0F, 48.0F, new CubeDeformation(0.0F))
						.texOffs(72, 66).addBox(-6.6F, -10.0F, -49.2667F, 12.0F, 2.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition CentralBody5 = Body.addOrReplaceChild("CentralBody5",
				CubeListBuilder.create().texOffs(100, 116).addBox(-10.6F, -6.0F, -58.2667F, 2.0F, 12.0F, 48.0F, new CubeDeformation(0.0F))
						.texOffs(72, 66).addBox(-6.6F, -10.0F, -58.2667F, 12.0F, 2.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition VeticalFIre = Charge.addOrReplaceChild("VeticalFIre", CubeListBuilder.create(), PartPose.offset(0.0F, 8.0F, 26.0F));
		PartDefinition bone = VeticalFIre.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(140, 0).addBox(-15.0F, -29.5F, 0.0F, 30.0F, 30.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = bone3.addOrReplaceChild(
				"cube_r1", CubeListBuilder.create().texOffs(140, 0).mirror()
		...
		PartDefinition cube_r2 = bone5.addOrReplaceChild(
				"cube_r2", CubeListBuilder.create().texOffs(140, 0).mirror()
		...
		PartDefinition cube_r3 = bone6.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(140, 0).addBox(-15.0F, -15.0F, 0.0F, 30.0F, 30.0F, 0.0F, new CubeDeformation(0.0F)),
