...
import net.mcreator.omni.client.renderer.DragonChargeLvl1Renderer;
...
public class OmniModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(OmniModEntities.DRAGON_CHARGE_LVL_1.get(), DragonChargeLvl1Renderer::new);
