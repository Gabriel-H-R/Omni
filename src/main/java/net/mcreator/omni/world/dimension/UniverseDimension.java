...
package net.mcreator.omni.world.dimension;
...
public class UniverseDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("omni:universe"), customEffect));
		}
	}
}
