...
import net.mcreator.omni.init.OmniModBiomes;
...
@Mod("omni")
public class OmniMod {
	public static final Logger LOGGER = LogManager.getLogger(OmniMod.class);
	...
	public OmniMod() {
		...
		OmniModItems.REGISTRY.register(bus);
		OmniModEntities.REGISTRY.register(bus);
